  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        {[
          { label: 'Total Staff', value: counts.total, color: 'text-blue-700', bg: 'bg-blue-50', border: 'border-blue-100', icon: Users },
          { label: 'Checked In', value: counts.active, color: 'text-green-700', bg: 'bg-green-50', border: 'border-green-100', icon: CheckCircle },
          { label: 'Delayed', value: counts.delayed, color: 'text-yellow-700', bg: 'bg-yellow-50', border: 'border-yellow-100', icon: Clock },
          { label: 'Absent', value: counts.absent, color: 'text-red-700', bg: 'bg-red-50', border: 'border-red-100', icon: XCircle },
        ].map(({ label, value, color, bg, border, icon: Icon }) => (
          <div key={label} className={`${bg} border ${border} p-5 rounded-2xl flex items-center gap-4`}>
